...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		subtitle: 'Simple destiny 2 cheats visuals — ESP, wallhack, aimbot, and radar for Destiny 2 on PC.',
		lead: 'Destiny 2 Cheats helps you spot players, agents, abilities, and bomb sites with ESP, aimbot, and radar in one license.',
		highlights: [
			{ title: 'destiny 2 cheats esp', copy: 'See players through walls with destiny 2 cheats esp and wallhack overlays.' },
			{ title: 'destiny 2 cheats radar', copy: 'Track nearby threats with destiny 2 cheats radar before you push or rotate.' },
			{ title: 'destiny 2 cheats aimbot', copy: 'Use aimbot and aimbot controls tuned for Destiny 2 matches on Windows PC.' },
		],
	...
	es: {
		...
		lead: 'Destiny 2 Cheats está pensado para el loop competitivo de Destiny 2: leer el mapa, rastrear escuadrones enemigos, lootear y ganar rondas.',
		highlights: [
		...
		updatesLabel: 'Actualizaciones Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	fr: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats suit la boucle competitivo de Destiny 2 : lire la carte, suivre les équipes, loot et gagner les rounds.',
		highlights: [
		...
		updatesLabel: 'Mises à jour Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	de: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats passt zur Raid-Schleife von Destiny 2: Karte lesen, Gegner tracken, looten und matches überleben.',
		highlights: [
	...
	pt: {
		...
		lead: 'Destiny 2 Cheats segue o loop BR do Destiny 2: ler o mapa, rastrear equipes, lootar e sobreviver ao extract.',
		highlights: [
		...
		updatesLabel: 'Atualizações Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	it: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats è pensato per il loop BR di Destiny 2: leggere la mappa, tracciare squadre nemiche, loot e sopravvivere al extract.',
		highlights: [
		...
		updatesLabel: 'Aggiornamenti Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	nl: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats volgt de match-loop va Destiny 2: kaart lezen, vijandelijke squads volgen, jagen en combat zones overleven.',
		highlights: [
	...
	pl: {
		...
		lead: 'Destiny 2 Cheats pasuje do pętli BR Destiny 2: czytaj mapę, śledź wrogie drużyny, lootuj i przeżyj extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizacje Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	ru: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats создан для рейд-циклу Destiny 2: читать карту, отслеживать вражеские отряды, лут и выживать в extract.',
		highlights: [
		...
		updatesLabel: 'Обновления Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	tr: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats, Destiny 2 BR döngüsü için: haritayı oku, düşman takımları izle, loot al ve extract\'da hayatta kal.',
		highlights: [
		...
		updatesLabel: 'Destiny 2 Cheats güncellemeleri',
		updatesShort: 'Updates',
	},
	ar: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats مبني لحلقة BR في Destiny 2: قراءة الخريطة، تتبع الفرق، جمع اللوت والنجاة في extract.',
		highlights: [
		...
		updatesLabel: 'تحديثات Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	ja: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 CheatsはDestiny 2のBRループ向け：マップを読み、敵スクワッドを追跡し、ルートしてextractを生き延びる。',
		highlights: [
		...
		updatesLabel: 'Destiny 2 Cheats更新',
		updatesShort: 'Updates',
	},
	ko: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats는 Destiny 2 survival loop용: 맵 읽기, 적 스쿼드 추적, 루트 수집, extract 생존.',
		highlights: [
		...
		updatesLabel: 'Destiny 2 Cheats 업데이트',
		updatesShort: 'Updates',
	},
	zh: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats 为 Destiny 2 match loop设计：读图、追踪敌方小队、搜刮并在 base survival。',
		highlights: [
		...
		updatesLabel: 'Destiny 2 Cheats 更新',
		updatesShort: 'Updates',
	},
	hi: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats Destiny 2 match loop के लिए: map पढ़ें, enemy squads track करें, loot करें और base survival करें।',
		highlights: [
	...
	id: {
		...
		lead: 'Destiny 2 Cheats untuk loop BR Destiny 2: baca peta, lacak squad musuh, loot, dan selamat di extract.',
		highlights: [
		...
		updatesLabel: 'Update Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	th: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats สำหรับลูป BR ของ Destiny 2: อ่านแผนที่ ติดตามทีมศัตรู เก็บ loot และรอด extract',
		highlights: [
		...
		updatesLabel: 'อัปเดต Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	vi: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats cho vòng BR Destiny 2: đọc bản đồ, theo dõi squad địch, loot và sống sót extract.',
		highlights: [
		...
		updatesLabel: 'Cập nhật Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	uk: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats для рейд-циклу Destiny 2: читати карту, відстежувати ворожі загони, лут і виживати в extract.',
		highlights: [
		...
		updatesLabel: 'Оновлення Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	cs: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats pro BR smyčku Destiny 2: číst mapu, sledovat nepřátelské squady, loot a přežít extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizace Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	ro: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats pentru bucla BR Destiny 2: citește harta, urmărește squad-uri inamice, loot și supraviețuiește extract.',
		highlights: [
		...
		updatesLabel: 'Actualizări Destiny 2 Cheats',
		updatesShort: 'Updates',
	},
	sv: {
		eyebrow: 'Destiny 2 Cheats',
		...
		lead: 'Destiny 2 Cheats för Destiny 2:s match-loop: läs kartan, spåra fiendesquads, loota och överlev extract.',
		highlights: [
		...
		updatesLabel: 'Destiny 2 Cheats uppdateringar',
		updatesShort: 'Updates',
	},
};
