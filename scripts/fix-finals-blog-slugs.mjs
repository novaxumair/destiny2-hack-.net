...
const KEYWORD_REPLACEMENTS = [
	[/\bthe rust patch notes\b/gi, 'Destiny 2 patch notes'],
	[/\brust major update\b/gi, 'Destiny 2 major update'],
	[/\brust intel\b/gi, 'Finals intel'],
	[/\brust skins\b/gi, 'Destiny 2 cosmetics'],
	[/\brust cosmetics\b/gi, 'Destiny 2 cosmetics'],
	[/\bthe rust skins\b/gi, 'Destiny 2 cosmetics'],
	[/\brust player tier\b/gi, 'Destiny 2 weapon tier'],
	[/\brust loot routes\b/gi, 'Destiny 2 movement routes'],
	[/\brust warmup\b/gi, 'Destiny 2 warmup'],
	[/\brust pro settings\b/gi, 'Destiny 2 pro settings'],
	[/\brust competitive meta\b/gi, 'Destiny 2 competitive meta'],
	[/\brust farming run\b/gi, 'Destiny 2 loot run'],
