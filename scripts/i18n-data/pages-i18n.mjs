...
export const PAGE_META_HOME = {
	es: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack y Aimbot', desc: 'Trucos Destiny 2 indetectables para Destiny 2 en PC. ESP wallhack, radar hack y Aimbot con mantenimiento BattlEye. Entrega digital instantánea.', h1: 'cheats indetectables para Destiny 2', intro: 'Paquete undetected para Destiny 2 en Windows PC: ESP wallhack, radar y Aimbot con mantenimiento BattlEye tras cada parche.', imageAlt: 'Destiny 2 ESP — etiquetas de jugador hack', gallery: 'Galería Destiny 2 Cheats — ESP, Aimbot y wallhack', cta2: 'Ver funciones', h2a: 'Por qué eligen Destiny 2 Cheats en 2026', h2b: 'ESP wallhack, radar y Aimbot en una licencia', topicA: 'Ideal para leer escuadrones enemigos en BR y Quick Play sessions.', topicB: 'Una licencia en lugar de herramientas separadas.' },
	fr: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack et Aimbot', desc: 'Triches Destiny 2 indétectables pour Destiny 2 sur PC. ESP wallhack, radar hack et Aimbot avec maintenance BattlEye. Livraison numérique instantanée.', h1: 'triches indétectables pour Destiny 2', intro: 'Pack undetected pour Destiny 2 sur PC Windows : ESP wallhack, radar et Aimbot avec maintenance BattlEye après chaque patch.', imageAlt: 'Destiny 2 ESP — tags joueur hack', gallery: 'Galerie Destiny 2 Cheats — ESP, Aimbot et wallhack', cta2: 'Voir les fonctions', h2a: 'Pourquoi choisir Destiny 2 Cheats en 2026', h2b: 'ESP wallhack, radar et Aimbot en une licence', topicA: 'Parfait pour lire les équipes ennemies en BR et Quick Play sessions.', topicB: 'Une licence au lieu d\'outils séparés.' },
	de: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Destiny 2 Cheats für Destiny 2 auf PC. ESP Wallhack, Radar Hack und Aimbot mit BattlEye-Wartung. Sofortige digitale Lieferung.', h1: 'undetected Cheats für Destiny 2', intro: 'Undetected Windows PC Paket für Destiny 2: ESP Wallhack, Radar und Aimbot mit BattlEye-Wartung nach jedem Patch.', imageAlt: 'Destiny 2 ESP — Spieler-Tags Hack', gallery: 'Destiny 2 Cheats Galerie — ESP, Aimbot und Wallhack', cta2: 'Features ansehen', h2a: 'Warum Destiny 2 Cheats 2026 führt', h2b: 'ESP Wallhack, Radar und Aimbot in einer Lizenz', topicA: 'Ideal um feindliche Squads in BR und Quick Play sessions zu lesen.', topicB: 'Eine Lizenz statt separater Tools.' },
	pt: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats Destiny 2 indetectáveis para Destiny 2 no PC. ESP wallhack, radar hack e Aimbot com manutenção BattlEye. Entrega digital instantánea.', h1: 'cheats indetectáveis para Destiny 2', intro: 'Pacote undetected para Destiny 2 no Windows PC: ESP wallhack, radar e Aimbot com manutenção BattlEye após cada patch.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galeria Destiny 2 Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher Destiny 2 Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler equipes inimigos em BR e Quick Play sessions.', topicB: 'Uma licença em vez de ferramentas separadas.' },
	it: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheat Destiny 2 indetectable per Destiny 2 su PC. ESP wallhack, radar hack e Aimbot con manutenzione BattlEye. Consegna digitale istantanea.', h1: 'cheat indetectable per Destiny 2', intro: 'Pacchetto undetected per Destiny 2 su PC Windows: ESP wallhack, radar e Aimbot con manutenzione BattlEye dopo ogni patch.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galleria Destiny 2 Cheats — ESP, Aimbot e wallhack', cta2: 'Vedi funzioni', h2a: 'Perché scegliere Destiny 2 Cheats nel 2026', h2b: 'ESP wallhack, radar e Aimbot in una licenza', topicA: 'Ideale per leggere squadre nemiche in BR e Quick Play sessions.', topicB: 'Una licenza invece di tool separati.' },
	nl: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected destiny 2 cheats voor Destiny 2 op PC. ESP wallhack, radar hack en Aimbot met BattlEye-onderhoud. Directe digitale levering.', h1: 'undetected cheats voor Destiny 2', intro: 'Undetected Windows PC pakket voor Destiny 2: ESP wallhack, radar en Aimbot met BattlEye-onderhoud na elke patch.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Destiny 2 Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Destiny 2 Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in BR en Quick Play sessions.', topicB: 'Eén licentie in plaats van losse tools.' },
	pl: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack i Aimbot', desc: 'Undetected cheaty Destiny 2 dla Destiny 2 na PC. ESP wallhack, radar hack i Aimbot z konserwacją BattlEye. Natychmiastowa dostawa cyfrowa.', h1: 'undetected cheaty dla Destiny 2', intro: 'Pakiet undetected dla Destiny 2 na Windows PC: ESP wallhack, radar i Aimbot z konserwacją BattlEye po każdym patchu.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galeria Destiny 2 Cheats — ESP, Aimbot i wallhack', cta2: 'Zobacz funkcje', h2a: 'Dlaczego Destiny 2 Cheats w 2026', h2b: 'ESP wallhack, radar i Aimbot w jednej licencji', topicA: 'Idealny do czytania wrogich squadów w BR i Quick Play sessions.', topicB: 'Jedna licencja zamiast osobnych narzędzi.' },
	ru: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack и Aimbot', desc: 'Undetected читы Destiny 2 для Destiny 2 на PC. ESP wallhack, radar hack и Aimbot с обслуживанием BattlEye. Мгновенная цифровая доставка.', h1: 'undetected читы для Destiny 2', intro: 'Undetected пакет для Destiny 2 на Windows PC: ESP wallhack, radar и Aimbot с обслуживанием BattlEye после патчей.', imageAlt: 'Destiny 2 ESP — теги игроков hack', gallery: 'Галерея Destiny 2 Cheats — ESP, Aimbot и wallhack', cta2: 'Смотреть функции', h2a: 'Почему выбирают Destiny 2 Cheats в 2026', h2b: 'ESP wallhack, radar и Aimbot в одной лицензии', topicA: 'Идеально для чтения вражеских отрядов в BR и Quick Play sessions.', topicB: 'Одна лицензия вместо отдельных инструментов.' },
	tr: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'Destiny 2 için undetected hileler. ESP wallhack, radar hack ve Aimbot — BattlEye bakımı. Anında dijital teslimat.', h1: 'Destiny 2 için undetected hileler', intro: 'Destiny 2 Windows PC undetected paketi: ESP wallhack, radar ve Aimbot — BattlEye bakımı dahil.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Destiny 2 Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden Destiny 2 Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'BR ve Quick Play sessions\'da düşman squad okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'Destiny 2 Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش Destiny 2 undetected لـ Destiny 2 على PC. ESP wallhack ورadar hack وAimbot مع صيانة BattlEye. تسليم رقمي فوري.', h1: 'غش غير مكتشف لـ Destiny 2', intro: 'حزمة undetected لـ Destiny 2 على Windows PC: ESP wallhack ورadar وAimbot مع صيانة BattlEye.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'معرض Destiny 2 Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Destiny 2 Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في BR وQuick Play sessions.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'Destiny 2 Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'Destiny 2向けundetectedチート。ESP wallhack、radar hack、Aimbot、BattlEyeメンテナンス。即時デジタル配信。', h1: 'Destiny 2向けundetectedチート', intro: 'Destiny 2 Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、BattlEyeメンテナンス付き。', imageAlt: 'destiny 2 cheats guardian ESP aimbot wallhack', gallery: 'Destiny 2 Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にDestiny 2 Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとQuick Play sessionsで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'Destiny 2 undetected 치트. ESP wallhack, radar hack, Aimbot, BattlEye 유지보수. 즉시 디지털 배송.', h1: 'Destiny 2용 undetected 치트', intro: 'Destiny 2 Windows PC undetected 패키지: ESP wallhack, radar, Aimbot, BattlEye 유지보수 포함.', imageAlt: 'destiny 2 cheats guardian ESP aimbot wallhack', gallery: 'Destiny 2 Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 Destiny 2 Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'BR 및 Quick Play sessions에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'Destiny 2 Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Destiny 2 undetected作弊。ESP wallhack、radar hack、Aimbot、BattlEye维护。即时数字交付。', h1: 'Destiny 2的undetected外挂', intro: 'Destiny 2 Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含BattlEye维护。', imageAlt: 'destiny 2 cheats guardian ESP aimbot wallhack', gallery: 'Destiny 2 Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Destiny 2 Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和Quick Play sessions中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	hi: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack और Aimbot', desc: 'Destiny 2 undetected hacks. ESP wallhack, radar hack, Aimbot, BattlEye maintenance. Instant digital delivery.', h1: 'Destiny 2 ke liye undetected cheats', intro: 'Destiny 2 Windows PC undetected पैकेज: ESP wallhack, radar, Aimbot, BattlEye maintenance सहित.', imageAlt: 'destiny 2 cheats guardian ESP aimbot wallhack', gallery: 'Destiny 2 Cheats gallery — ESP, Aimbot, wallhack', cta2: 'फ़ीचर्स देखें', h2a: '2026 में Destiny 2 Cheats क्यों', h2b: 'ESP wallhack, radar, Aimbot एक लाइसेंस में', topicA: 'BR और Quick Play sessions में दुश्मन squad पढ़ने के लिए आदर्श.', topicB: 'अलग टूल्स के बजाय एक लाइसेंस.' },
	id: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Destiny 2 undetected untuk Destiny 2 di PC. ESP wallhack, radar hack, Aimbot, pemeliharaan BattlEye. Pengiriman digital instan.', h1: 'cheat undetected untuk Destiny 2', intro: 'Paket undetected Destiny 2 di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan BattlEye.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galeri Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Destiny 2 Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di BR dan Quick Play sessions.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	th: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack และ Aimbot', desc: 'Cheat Destiny 2 undetected สำหรับ Destiny 2 บน PC. ESP wallhack, radar hack, Aimbot, BattlEye maintenance. จัดส่งดิจิทัลทันที.', h1: 'cheat undetected สำหรับ Destiny 2', intro: 'แพ็ก undetected สำหรับ Destiny 2 บน Windows PC: ESP wallhack, radar, Aimbot พร้อม BattlEye maintenance', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'แกลเลอรี Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'ดูฟีเจอร์', h2a: 'ทำไมเลือก Destiny 2 Cheats ปี 2026', h2b: 'ESP wallhack, radar, Aimbot ในใบอนุญาตเดียว', topicA: 'เหมาะสำหรับอ่าน squad ศัตรูใน BR และ Quick Play sessions', topicB: 'ใบอนุญาตเดียวแทนเครื่องมือแยก' },
	vi: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Destiny 2 undetected cho Destiny 2 trên PC. ESP wallhack, radar hack, Aimbot, bảo trì BattlEye. Giao hàng kỹ thuật số tức thì.', h1: 'cheat undetected cho Destiny 2', intro: 'Gói undetected Destiny 2 trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì BattlEye.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Thư viện Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Destiny 2 Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong BR và Quick Play sessions.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
	uk: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack і Aimbot', desc: 'Undetected чіти Destiny 2 для Destiny 2 на PC. ESP wallhack, radar hack, Aimbot, обслуговування BattlEye. Мгновенная цифровая доставка.', h1: 'undetected чіти для Destiny 2', intro: 'Undetected пакет для Destiny 2 на Windows PC: ESP wallhack, radar, Aimbot з обслуговуванням BattlEye.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Галерея Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Дивитися функції', h2a: 'Чому Destiny 2 Cheats у 2026', h2b: 'ESP wallhack, radar і Aimbot в одній ліцензії', topicA: 'Ідеально для читання ворожих загонів у BR і Quick Play sessions.', topicB: 'Одна ліцензія замість окремих інструментів.' },
	cs: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack a Aimbot', desc: 'Undetected destiny 2 cheaty pro Destiny 2 na PC. ESP wallhack, radar hack, Aimbot, údržba BattlEye. Okamžité digitální doručení.', h1: 'undetected cheaty pro Destiny 2', intro: 'Undetected balíček pro Destiny 2 na Windows PC: ESP wallhack, radar, Aimbot s údržbou BattlEye.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galerie Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Zobrazit funkce', h2a: 'Proč Destiny 2 Cheats v roce 2026', h2b: 'ESP wallhack, radar a Aimbot v jedné licenci', topicA: 'Ideální pro čtení nepřátelských squadů v BR a Quick Play sessions.', topicB: 'Jedna licence místo samostatných nástrojů.' },
	ro: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack și Aimbot', desc: 'Cheats Destiny 2 undetected pentru Destiny 2 pe PC. ESP wallhack, radar hack, Aimbot, mentenanță BattlEye. Livrare digitală instantă.', h1: 'cheat-uri undetected pentru Destiny 2', intro: 'Pachet undetected Destiny 2 pe Windows PC: ESP wallhack, radar, Aimbot cu mentenanță BattlEye.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galerie Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Vezi funcții', h2a: 'De ce Destiny 2 Cheats în 2026', h2b: 'ESP wallhack, radar și Aimbot într-o licență', topicA: 'Ideal pentru citirea squad-urilor inamice în BR și Quick Play sessions.', topicB: 'O licență în loc de instrumente separate.' },
	sv: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected destiny 2 cheats för Destiny 2 på PC. ESP wallhack, radar hack, Aimbot, BattlEye-underhåll. Omedelbar digital leverans.', h1: 'undetected cheats för Destiny 2', intro: 'Undetected paket för Destiny 2 på Windows PC: ESP wallhack, radar, Aimbot med BattlEye-underhåll.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Destiny 2 Cheats galleri — ESP, Aimbot, wallhack', cta2: 'Se funktioner', h2a: 'Varför Destiny 2 Cheats 2026', h2b: 'ESP wallhack, radar och Aimbot i en licens', topicA: 'Ideal för att läsa fiendesquads i BR och Quick Play sessions.', topicB: 'En licens istället för separata verktyg.' },
};
...
export const PAGE_META_TAILS = {
	...
	battleye: { suffix: 'Patch Maintenance', focus: 'how BattlEye updates are handled for Destiny 2 cheats', altKeyword: 'BattlEye bypass ESP aimbot' },
	'cheats-2026': { suffix: 'Buyer Guide', focus: '2026 destiny 2 cheats checklist before checkout', altKeyword: 'hacks 2026 ESP aimbot' },
	hacks: { suffix: 'ESP Aimbot Guide', focus: 'Destiny 2 Cheats pillar for ESP and Aimbot', altKeyword: 'hacks ESP aimbot' },
	...
	'best-cheats': { suffix: 'Buyer Checklist', focus: 'what to compare before buying destiny 2 cheats', altKeyword: 'best hacks ESP aimbot' },
...
export function buildLegal(locale, pageKey, kind) {
	...
	return {
		title: clampTitle(stripResellerFromMeta(`${h1} | Destiny 2 Cheats`)),
		description: clampDesc(stripResellerFromMeta(`${h1} ${L?.descFor ?? 'for Destiny 2 Cheats — ESP wallhack, Aimbot'}, ${p.win}.`)),
		h1,
