...
export const PAGE_IMAGE_ALTS = {
	...
	features: 'Destiny 2 Cheats features — ESP, aimbot, and radar screenshots',
	...
	'mod-menu': 'Destiny 2 Cheats in-game menu controls',
	...
	'unlock-all': 'Destiny 2 Cheats license features overview',
