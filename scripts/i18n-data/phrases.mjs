...
const KW = {
	hacks: 'destiny 2 hacks',
	cheats: 'destiny 2 hacks',
	hack: 'destiny 2 cheat',
	esp: 'Destiny 2 ESP',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'Destiny 2 Aimbot',
	product: 'Destiny 2 Hacks',
	game: 'Destiny 2',
	checkout: 'Store',
	eac: 'BattlEye',
};
...
export const phrases = {
	es: {
		buy: 'Comprar Destiny 2 Hacks', undetected: 'indetectables', maps: 'maps, zones, and combat points',
		...
		legal: () => 'Contacta support@destiny2hack.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Destiny 2 Hacks', undetected: 'indétectables', maps: 'maps, zones, and combat points',
		...
		legal: () => 'Contactez support@destiny2hack.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Destiny 2 Hacks kaufen', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Destiny 2 Hacks', undetected: 'indetectáveis', maps: 'maps, zones, and combat points',
		...
		legal: () => 'Contacte support@destiny2hack.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Destiny 2 Hacks', undetected: 'indetectable', maps: 'maps, zones, and combat points',
		...
		legal: () => 'Contatta support@destiny2hack.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'Destiny 2 Hacks kopen', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Destiny 2 Hacks satın al', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'Destek ve yasal sorular için support@destiny2hack.net.',
	},
	ar: {
		buy: 'اشترِ Destiny 2 Hacks', undetected: 'غير مكتشف', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Destiny 2 Hacksを購入', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'サポート・法務: support@destiny2hack.net',
	},
	ko: {
		buy: 'Destiny 2 Hacks 구매', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => '지원 및 법무: support@destiny2hack.net',
	},
	zh: {
		buy: '购买 Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => '支持与法务：support@destiny2hack.net',
	},
	hi: {
		buy: 'Destiny 2 Hacks खरीदें', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'सहायता: support@destiny2hack.net',
	},
	id: {
		buy: 'Beli Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Destiny 2 Hacks', undetected: 'undetected', maps: 'maps, zones, and combat points',
		...
		legal: () => 'support@destiny2hack.net för support och juridik.',
	},
};
