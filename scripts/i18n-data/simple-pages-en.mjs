 ...
 * Used as canonical EN content for features, pricing, updates, hacks, destiny-2-esp, destiny-2-aimbot, radar, setup, support, faq.
 */
...
export const simplePagesEn = {
		...
		sections: [
			{
				...
				list: ['Player boxes & distance', 'Loot and guardian markers', 'Objective and vehicle filters'],
			},
			{
				h2: 'Aimbot & aimbot',
				paragraphs: [
			...
			},
			{
				...
				paragraphs: [
					'Most Destiny 2 cheat sites cover ESP, aimbot, radar, setup, and status on separate pages. Use these guides next:',
			...
			},
			{
				h2: 'Updates & support',
				paragraphs: [
					'We rebuild after big Destiny 2 or BattlEye patches.',
	...
	'destiny-2-esp': {
		title: 'Destiny 2 ESP | Wallhack & Player Boxes',
		description:
	...
	'destiny-2-aimbot': {
		title: 'Destiny 2 Aimbot | aimbot & FOV Settings',
		description:
	...
	radar: {
		title: 'Destiny 2 Radar Hack | 2D Threat Map',
		description:
