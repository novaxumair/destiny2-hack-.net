...
const UI = {
	es: {
		...
		gallery: 'Aspecto en juego', buy: 'Comprar Destiny 2 Hacks', viewStore: 'Ver tienda', setupGuide: 'Guía de instalación',
		checkStatus: 'Ver estado', overview: 'Resumen Destiny 2 Hacks', viewFeatures: 'Ver funciones', contactSupport: 'Contactar soporte',
		inGame: 'Aspecto en juego', fullGuide: 'Destiny 2 Hacks — Guía completa',
	},
	fr: {
		features: 'Fonctions', store: 'Boutique', status: 'Statut', setup: 'Installation', support: 'Support', faq: 'FAQ',
		gallery: 'Rendu en jeu', buy: 'Acheter Destiny 2 Hacks', viewStore: 'Voir la boutique', setupGuide: "Guide d'installation",
		checkStatus: 'Voir le statut', overview: 'Aperçu Destiny 2 Hacks', viewFeatures: 'Voir les fonctions', contactSupport: 'Contacter le support',
		inGame: 'Rendu en jeu', fullGuide: 'Destiny 2 Hacks — Guide complet',
	},
	de: {
		features: 'Features', store: 'Shop', status: 'Status', setup: 'Setup', support: 'Support', faq: 'FAQ',
		gallery: 'Ingame-Ansicht', buy: 'Destiny 2 Hacks kaufen', viewStore: 'Shop ansehen', setupGuide: 'Setup-Anleitung',
		checkStatus: 'Status prüfen', overview: 'Destiny 2 Hacks Übersicht', viewFeatures: 'Features ansehen', contactSupport: 'Support kontaktieren',
		inGame: 'Ingame-Ansicht', fullGuide: 'Destiny 2 Hacks — Vollständiger Guide',
	},
	pt: {
		features: 'Recursos', store: 'Loja', status: 'Status', setup: 'Instalação', support: 'Suporte', faq: 'FAQ',
		gallery: 'Visual in-game', buy: 'Comprar Destiny 2 Hacks', viewStore: 'Ver loja', setupGuide: 'Guia de instalação',
		checkStatus: 'Ver status', overview: 'Visão geral Destiny 2 Hacks', viewFeatures: 'Ver recursos', contactSupport: 'Contactar suporte',
		inGame: 'Visual in-game', fullGuide: 'Destiny 2 Hacks — Guia completo',
	},
	it: {
		features: 'Funzioni', store: 'Negozio', status: 'Stato', setup: 'Setup', support: 'Supporto', faq: 'FAQ',
		gallery: 'Aspetto in-game', buy: 'Acquista Destiny 2 Hacks', viewStore: 'Vedi negozio', setupGuide: 'Guida installazione',
		checkStatus: 'Controlla stato', overview: 'Panoramica Destiny 2 Hacks', viewFeatures: 'Vedi funzioni', contactSupport: 'Contatta supporto',
		inGame: 'Aspetto in-game', fullGuide: 'Destiny 2 Hacks — Guida completa',
	},
	nl: {
		features: 'Functies', store: 'Winkel', status: 'Status', setup: 'Setup', support: 'Support', faq: 'FAQ',
		gallery: 'In-game weergave', buy: 'Destiny 2 Hacks kopen', viewStore: 'Winkel bekijken', setupGuide: 'Installatiegids',
		checkStatus: 'Status controleren', overview: 'Destiny 2 Hacks overzicht', viewFeatures: 'Functies bekijken', contactSupport: 'Contact support',
		inGame: 'In-game weergave', fullGuide: 'Destiny 2 Hacks — Volledige gids',
	},
	pl: {
		features: 'Funkcje', store: 'Sklep', status: 'Status', setup: 'Instalacja', support: 'Wsparcie', faq: 'FAQ',
		gallery: 'Wygląd w grze', buy: 'Kup Destiny 2 Hacks', viewStore: 'Zobacz sklep', setupGuide: 'Przewodnik instalacji',
		checkStatus: 'Sprawdź status', overview: 'Przegląd Destiny 2 Hacks', viewFeatures: 'Zobacz funkcje', contactSupport: 'Kontakt z supportem',
		inGame: 'Wygląd w grze', fullGuide: 'Destiny 2 Hacks — Pełny przewodnik',
	},
	ru: {
		features: 'Функции', store: 'Магазин', status: 'Статус', setup: 'Установка', support: 'Поддержка', faq: 'FAQ',
		gallery: 'Вид в игре', buy: 'Купить Destiny 2 Hacks', viewStore: 'Открыть магазин', setupGuide: 'Гайд по установке',
		checkStatus: 'Проверить статус', overview: 'Обзор Destiny 2 Hacks', viewFeatures: 'Смотреть функции', contactSupport: 'Связаться с поддержкой',
		inGame: 'Вид в игре', fullGuide: 'Destiny 2 Hacks — Полный гайд',
	},
	tr: {
		features: 'Özellikler', store: 'Mağaza', status: 'Durum', setup: 'Kurulum', support: 'Destek', faq: 'SSS',
		gallery: 'Oyun içi görünüm', buy: 'Destiny 2 Hacks satın al', viewStore: 'Mağazayı gör', setupGuide: 'Kurulum rehberi',
		checkStatus: 'Durumu kontrol et', overview: 'Destiny 2 Hacks genel bakış', viewFeatures: 'Özellikleri gör', contactSupport: 'Destekle iletişim',
		inGame: 'Oyun içi görünüm', fullGuide: 'Destiny 2 Hacks — Tam rehber',
	},
	ar: {
		features: 'الميزات', store: 'المتجر', status: 'الحالة', setup: 'التثبيت', support: 'الدعم', faq: 'الأسئلة الشائعة',
		gallery: 'المظهر داخل اللعبة', buy: 'اشترِ Destiny 2 Hacks', viewStore: 'عرض المتجر', setupGuide: 'دليل التثبيت',
		checkStatus: 'تحقق من الحالة', overview: 'نظرة عامة على Destiny 2 Hacks', viewFeatures: 'عرض الميزات', contactSupport: 'اتصل بالدعم',
		inGame: 'المظهر داخل اللعبة', fullGuide: 'Destiny 2 Hacks — دليل كامل',
	},
	ja: {
		features: '機能', store: 'ストア', status: 'ステータス', setup: 'セットアップ', support: 'サポート', faq: 'FAQ',
		gallery: 'ゲーム内の見た目', buy: 'Destiny 2 Hacksを購入', viewStore: 'ストアを見る', setupGuide: 'セットアップガイド',
		checkStatus: 'ステータスを確認', overview: 'Destiny 2 Hacks概要', viewFeatures: '機能を見る', contactSupport: 'サポートに連絡',
		inGame: 'ゲーム内の見た目', fullGuide: 'Destiny 2 Hacks — 完全ガイド',
	},
	ko: {
		features: '기능', store: '스토어', status: '상태', setup: '설치', support: '지원', faq: 'FAQ',
		gallery: '인게임 화면', buy: 'Destiny 2 Hacks 구매', viewStore: '스토어 보기', setupGuide: '설치 가이드',
		checkStatus: '상태 확인', overview: 'Destiny 2 Hacks 개요', viewFeatures: '기능 보기', contactSupport: '지원 문의',
		inGame: '인게임 화면', fullGuide: 'Destiny 2 Hacks — 전체 가이드',
	},
	zh: {
		features: '功能', store: '商店', status: '状态', setup: '安装', support: '支持', faq: '常见问题',
		gallery: '游戏内效果', buy: '购买 Destiny 2 Hacks', viewStore: '查看商店', setupGuide: '安装指南',
		checkStatus: '查看状态', overview: 'Destiny 2 Hacks概览', viewFeatures: '查看功能', contactSupport: '联系支持',
		inGame: '游戏内效果', fullGuide: 'Destiny 2 Hacks — 完整指南',
	},
	hi: {
		features: 'फ़ीचर्स', store: 'स्टोर', status: 'स्टेटस', setup: 'सेटअप', support: 'सहायता', faq: 'FAQ',
		gallery: 'इन-गेम लुक', buy: 'Destiny 2 Hacks खरीदें', viewStore: 'स्टोर देखें', setupGuide: 'सेटअप गाइड',
		checkStatus: 'स्टेटस जांचें', overview: 'Destiny 2 Hacks अवलोकन', viewFeatures: 'फ़ीचर्स देखें', contactSupport: 'सहायता से संपर्क',
		inGame: 'इन-गेम लुक', fullGuide: 'Destiny 2 Hacks — पूर्ण गाइड',
	},
	id: {
		features: 'Fitur', store: 'Toko', status: 'Status', setup: 'Setup', support: 'Dukungan', faq: 'FAQ',
		gallery: 'Tampilan in-game', buy: 'Beli Destiny 2 Hacks', viewStore: 'Lihat toko', setupGuide: 'Panduan setup',
		checkStatus: 'Cek status', overview: 'Ringkasan Destiny 2 Hacks', viewFeatures: 'Lihat fitur', contactSupport: 'Hubungi dukungan',
		inGame: 'Tampilan in-game', fullGuide: 'Destiny 2 Hacks — Panduan lengkap',
	},
	th: {
		features: 'ฟีเจอร์', store: 'ร้านค้า', status: 'สถานะ', setup: 'ติดตั้ง', support: 'สนับสนุน', faq: 'FAQ',
		gallery: 'ลุคในเกม', buy: 'ซื้อ Destiny 2 Hacks', viewStore: 'ดูร้านค้า', setupGuide: 'คู่มือติดตั้ง',
		checkStatus: 'ตรวจสอบสถานะ', overview: 'ภาพรวม Destiny 2 Hacks', viewFeatures: 'ดูฟีเจอร์', contactSupport: 'ติดต่อฝ่ายสนับสนุน',
		inGame: 'ลุคในเกม', fullGuide: 'Destiny 2 Hacks — คู่มือฉบับสมบูรณ์',
	},
	vi: {
		features: 'Tính năng', store: 'Cửa hàng', status: 'Trạng thái', setup: 'Cài đặt', support: 'Hỗ trợ', faq: 'FAQ',
		gallery: 'Giao diện trong game', buy: 'Mua Destiny 2 Hacks', viewStore: 'Xem cửa hàng', setupGuide: 'Hướng dẫn cài đặt',
		checkStatus: 'Kiểm tra trạng thái', overview: 'Tổng quan Destiny 2 Hacks', viewFeatures: 'Xem tính năng', contactSupport: 'Liên hệ hỗ trợ',
		inGame: 'Giao diện trong game', fullGuide: 'Destiny 2 Hacks — Hướng dẫn đầy đủ',
	},
	uk: {
		features: 'Функції', store: 'Магазин', status: 'Статус', setup: 'Встановлення', support: 'Підтримка', faq: 'FAQ',
		gallery: 'Вигляд у грі', buy: 'Купити Destiny 2 Hacks', viewStore: 'Переглянути магазин', setupGuide: 'Гайд з встановлення',
		checkStatus: 'Перевірити статус', overview: 'Огляд Destiny 2 Hacks', viewFeatures: 'Дивитися функції', contactSupport: "Зв'язатися з підтримкою",
		inGame: 'Вигляд у грі', fullGuide: 'Destiny 2 Hacks — Повний гайд',
	},
	cs: {
		features: 'Funkce', store: 'Obchod', status: 'Stav', setup: 'Instalace', support: 'Podpora', faq: 'FAQ',
		gallery: 'Vzhled ve hře', buy: 'Koupit Destiny 2 Hacks', viewStore: 'Zobrazit obchod', setupGuide: 'Průvodce instalací',
		checkStatus: 'Zkontrolovat stav', overview: 'Přehled Destiny 2 Hacks', viewFeatures: 'Zobrazit funkce', contactSupport: 'Kontaktovat podporu',
		inGame: 'Vzhled ve hře', fullGuide: 'Destiny 2 Hacks — Kompletní průvodce',
	},
	ro: {
		features: 'Funcții', store: 'Magazin', status: 'Status', setup: 'Instalare', support: 'Suport', faq: 'FAQ',
		gallery: 'Aspect în joc', buy: 'Cumpără Destiny 2 Hacks', viewStore: 'Vezi magazinul', setupGuide: 'Ghid de instalare',
		checkStatus: 'Verifică statusul', overview: 'Prezentare Destiny 2 Hacks', viewFeatures: 'Vezi funcțiile', contactSupport: 'Contactează suportul',
		inGame: 'Aspect în joc', fullGuide: 'Destiny 2 Hacks — Ghid complet',
	},
	sv: {
		features: 'Funktioner', store: 'Butik', status: 'Status', setup: 'Installation', support: 'Support', faq: 'FAQ',
		gallery: 'Utseende i spelet', buy: 'Köp Destiny 2 Hacks', viewStore: 'Visa butik', setupGuide: 'Installationsguide',
		checkStatus: 'Kontrollera status', overview: 'Destiny 2 Hacks-översikt', viewFeatures: 'Visa funktioner', contactSupport: 'Kontakta support',
		inGame: 'Utseende i spelet', fullGuide: 'Destiny 2 Hacks — Fullständig guide',
	},
};
...
function buildFeatures(locale, u, p) {
	...
	if (!content) {
		return {
			title: clampTitle(`${u.features} 2026 | ESP, Aimbot & Radar | Destiny 2 Hacks`),
...
function simplePageTitle(h1, enTitle) {
	...
	const suffix = pipe >= 0 ? enTitle.slice(pipe).replace(/\s*Guide\s*$/i, '').trim() : '| Destiny 2 Hacks';
		...
		pages[pageId] = {
			...
			description: clampDesc(
				stripResellerFromMeta(
					`${h1} for Destiny 2 ranked & Trials on Windows PC — ${focus}. ${p.delivery}. Official destiny 2 hacks at destiny2hack.net.`,
				),
			),
			h1,
			intro: p.s1(`${h1}. ${focus}.`),
...
const SECTION_TITLES = {
	...
	whatAreCheats: { es: '¿Qué son los trucos de Destiny 2?', fr: 'Que sont les triches Destiny 2 ?', de: 'Was sind Destiny 2 Hacks?', pt: 'O que são cheats de Destiny 2?', it: 'Cosa sono i cheat Destiny 2?', nl: 'Wat zijn Destiny 2 hacks?', pl: 'Czym są cheaty Destiny 2?', ru: 'Что такое читы Destiny 2?', tr: 'Destiny 2 hileleri nedir?', ar: 'ما هي غش Destiny 2؟', ja: 'Destiny 2チートとは？', ko: 'Destiny 2 치트란?', zh: '什么是Destiny 2作弊？', hi: 'Destiny 2 hacks क्या हैं?', id: 'Apa itu cheat Destiny 2?', th: 'Destiny 2 hacks คืออะไร?', vi: 'Cheat Destiny 2 là gì?', uk: 'Що таке чіти Destiny 2?', cs: 'Co jsou destiny 2 cheaty?', ro: 'Ce sunt cheats Destiny 2?', sv: 'Vad är Destiny 2 hacks?' },
	whatIncludes: { es: 'Qué incluye Destiny 2 Hacks', fr: 'Ce que Destiny 2 Hacks inclut', de: 'Was Destiny 2 Hacks enthält', pt: 'O que o Destiny 2 Hacks inclui', it: 'Cosa include Destiny 2 Hacks', nl: 'Wat Destiny 2 Hacks bevat', pl: 'Co zawiera Destiny 2 Hacks', ru: 'Что входит в Destiny 2 Hacks', tr: 'Destiny 2 Hacks neleri içerir', ar: 'ماذا يتضمن Destiny 2 Hacks', ja: 'Destiny 2 Hacksの内容', ko: 'Destiny 2 Hacks 포함 사항', zh: 'Destiny 2 Hacks包含什么', hi: 'Destiny 2 Hacks में क्या शामिल है', id: 'Apa yang termasuk Destiny 2 Hacks', th: 'Destiny 2 Hacks รวมอะไรบ้าง', vi: 'Destiny 2 Hacks bao gồm gì', uk: 'Що входить до Destiny 2 Hacks', cs: 'Co obsahuje Destiny 2 Hacks', ro: 'Ce include Destiny 2 Hacks', sv: 'Vad Destiny 2 Hacks innehåller' },
