...
const sources = [
		...
		sections: [
			{
				...
				paragraphs: [
					...
					`If you also run third-party tools, separate game balance from anti-cheat maintenance. After a ${EXT.eac} or client update, check our <a href="/updates/">Destiny 2 Hacks status page</a> before you blame your own aim.`,
				],
			},
			{
		...
		sections: [
			{
				...
				paragraphs: [
					`BattlEye is documented at ${EXT.eac}. It evolves. Vendors who care publish rebuild notes when ESP, radar, or aim modules need work. Destiny 2 Hacks does that on <a href="/updates/">Updates</a> and explains the workflow on <a href="/updates/">BattlEye maintenance</a>.`,
	...
	},
	{
		...
		metaDescription:
			'How Destiny 2 Hacks compares to typical budget destiny 2 cheat shops — ESP depth, radar, status pages, pricing, and what “cheap” usually skips.',
		h1: 'Destiny 2 Hacks vs Typical Budget Destiny 2 Cheat Shops',
		intro:
	...
	},
	{
		...
		metaDescription:
			'A two-week test of another budget destiny 2 cheat before switching to Destiny 2 Hacks — ESP feel, soft aim, patch downtime, and support differences.',
	...
	},
	{
		...
		metaDescription:
			'Full-stack Destiny 2 Hacks versus minimal ESP-only Destiny 2 tools — feature depth, radar, soft aim, pricing, and who should buy which style.',
		h1: 'Full-Stack Destiny 2 Hacks vs Minimal ESP-Only Tools',
		intro:
